                            ...
                            <div className="p-4 sm:p-6">
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <select className="placeholder:text-neutral-500 file:border-solid file:border file:px-3 file:text-xs file:border-neutral-200 file:py-1 file:rounded-full block w-full px-2 py-2 mt-1 text-sm transition border border-neutral-200 focus:outline-none rounded-xl focus:border-neutral-400 focus:ring focus:ring-neutral-200" name="technical_document" id="technical_document">
                                            <option value="tds">TDS</option>
                                            <option value="std">STD</option>
                                        </select>
                                        <ErrorMessage error={errors.document_type} />
                                    </div>
                                    <div>
